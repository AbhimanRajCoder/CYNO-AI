        ...
        async def process_single_report(report):
            try:
                ...
                try:
                    ...
                    raise Exception("AI service (Ollama) is not running. Please start Ollama with 'ollama serve'.")
                ...
                if "Connection refused" in error_message or "Ollama" in error_message:
                    error_message = "AI service (Ollama) is not running. Please start Ollama with 'ollama serve'."
