...
class LLMModels:
    """Centralized LLM model name definitions."""
    
    # OCR Pipeline Models
    LLM_A = os.getenv("LLM_A_MODEL", "llama3.2")          # Structural extraction
    LLM_B = os.getenv("LLM_B_MODEL", "mistral:7b-instruct-q4_0")          # Validation/filtering
    
    # Tumor Board Models
    TUMOR_BOARD_MAIN = os.getenv("TUMOR_BOARD_MODEL", "deepseek-r1:8b")
    TUMOR_BOARD_AGENTS = os.getenv("TUMOR_AGENTS_MODEL", "llama3.2")
    
    # Agent-specific (can override via env)
    RADIOLOGY_AGENT = os.getenv("RADIOLOGY_AGENT_MODEL", "llama3.2")
    PATHOLOGY_AGENT = os.getenv("PATHOLOGY_AGENT_MODEL", "deepseek-r1:8b")
    CLINICAL_AGENT = os.getenv("CLINICAL_AGENT_MODEL", "llama3.2")
    RESEARCH_AGENT = os.getenv("RESEARCH_AGENT_MODEL", "deepseek-r1:8b")
    COORDINATOR_AGENT = os.getenv("COORDINATOR_AGENT_MODEL", "deepseek-r1:8b")
